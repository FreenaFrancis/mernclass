...
//   const [center, setCenter] = useState([10.56, 76.56]);

//   // Define a custom icon for bus stop locations
//   const busStopIcon = L.icon({
//     iconUrl: 'path-to-your-icon.png', // Replace with the actual path to your location icon image
//     iconSize: [32, 32],
//     iconAnchor: [16, 32],
//     popupAnchor: [0, -32],
//   });
...
//   useEffect(() => {
//     // Fetch bus stops data and update setBusStops
//     axios
//       .get('https://busparrot.com/pis/api/getstopsin.php', {
//         // Your API parameters
//       })
//       .then((response) => {
//         if (response.data && response.data.bus_stops) {
...
//       <MapContainer center={center} zoom={12} style={{ height: '800px', width: '100%' }}>
//         <TileLayer
...
//       })
//       .then((response) => {
//         console.log('API Response:', response.data.stops);
...
//   const visibleBusStops = busStops.filter((stop) => {
//     if (!mapBounds) return false;
//     return mapBounds.contains([stop.stop_lat, stop.stop_lon]);
//   });

//   return (
//     <div className='div1 container-fluid'>
//       <h1 className='h1' style={{ animation: 'blinking 2s infinite' }}>
//         <u>Bus Routes</u>
//       </h1>
...
const Map = () => {
  ...
  const pinkIcon = new L.Icon({
    iconUrl: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAJElEQVR42mP4DwQMHEGEbChkcHT0zAhKAVRHA0CwxgARF1CBAaQJJBkQAoX2AEBVYBRIAAQk7sC7pFmXAAAAABJRU5ErkJggg==',
    iconSize: [25, 41],
    iconAnchor: [12, 41],
    popupAnchor: [1, -34],
  });
